ROOMS = {
    ...
    'hall': {
        'description': 'Большой зал с эхом. На север ведет большая '  
        'дубовая дверь для которой нужен ключ.',
    ...
    'puzzle_chamber': {
        'description': 'Комната с вращающимися заточенными металлическими дисками. '
